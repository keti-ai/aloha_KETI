...
if __name__ == '__main__':
    ...
    bridgeNode = None
    try:
        robot_id = "syscon_puppet_right_P02"
        password = ""
        ...
        bridgeNode.subscribe_local_topic(topic_name="/puppet_right/joint_states", 
                                         value_type=JointState,
                                         to_json_converter=joint_state_to_json)
        
        bridgeNode.subscribe_local_topic(topic_name="/puppet_right/commands/joint_group", 
                                         value_type=JointGroupCommand,
                                         to_json_converter=joint_group_command_to_json)
        
        bridgeNode.subscribe_local_topic(topic_name="/puppet_right/commands/joint_signle", 
