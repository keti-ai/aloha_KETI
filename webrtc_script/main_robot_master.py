...
if __name__ == '__main__':
    ...
    try:
        ...
        bridgeNode.subscribe_local_topic(topic_name="/master_left/joint_states", 
                                         value_type=JointState,
                                         to_json_converter=joint_state_to_json)
        
        bridgeNode.subscribe_local_topic(topic_name="/master_right/joint_states", 
                                         value_type=JointState,
                                         to_json_converter=joint_state_to_json)
